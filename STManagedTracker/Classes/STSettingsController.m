...
// ___________________ HippoTracker
    ...
    [syncerSettings setValue:[NSString stringWithFormat:@"%d", NO] forKey:@"syncerAutoStart"];
...
- (NSString *)normalizeValue:(NSString *)value forKey:(NSString *)key {
    ...
    } else  if ([key hasSuffix:@"AutoStart"] || [key isEqualToString:@"localAccessToSettings"] || [key isEqualToString:@"deviceMotionUpdate"]) {
